  ...
  const [state, formAction, isPending] = useActionState(
    async (prevState: any, formDataObj: FormData) => {
      ...
      const processToastId = toast.loading(
        isEdit ? "UPDATING PROJECT..." : "PUBLISHING PROJECT...",
      );
                      ...
                      {!isPending && (
                        <div className="relative group">
                          ...
                          <Button
                            type="button"
                            variant="secondary"
                            className="text-xs py-2 px-4 shadow-[4px_4px_0px_0px_var(--color-brand-red)] group-hover:shadow-none group-hover:translate-x-[2px] group-hover:translate-y-[2px]"
                          >
                            Change Image
                          </Button>
                        </div>
              ...
              <div className="flex flex-col lg:flex-row gap-8">
                <div className="flex-1">
                  ...
                  <p className="mt-2 text-[10px] font-bold opacity-40 uppercase tracking-widest">
                    Tip: Use the TAB key for indentation. Pressing ENTER will
                    preserve line breaks in the detail view.
                  </p>
                </div>

                <div className="flex-1">
                  <label className="block text-xs font-black uppercase tracking-widest mb-2 opacity-40 italic">
                    Live Preview (Content View)
                  </label>
